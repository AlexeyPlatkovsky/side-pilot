...
- Keep business logic out of components so it is unit-testable without rendering (tests are authored by `.ai/skills/testing-pro/SKILL.md`).
...
| Topic | Reference |
|-------|-----------|
| Tauri windowing & the floating/non-activating panel | `.ai/conventions/react-tauri/tauri-windowing.md` |
| IPC, commands, `tauri-specta`, capabilities/permissions | `.ai/conventions/react-tauri/tauri-ipc-permissions.md` |
| State management (Zustand / TanStack Query) | `.ai/conventions/react-tauri/state-management.md` |
| Component structure & React performance | `.ai/conventions/react-tauri/react-performance.md` |
| Accessibility | `.ai/conventions/react-tauri/accessibility.md` |
| Cross-platform / WebView differences | `.ai/conventions/react-tauri/cross-platform.md` |
