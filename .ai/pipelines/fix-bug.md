...
Skill: `.ai/skills/testing-pro/SKILL.md`
...
Skill: `.ai/skills/verify-cli-adapter/SKILL.md`
...
**Trigger:** the fix changes observable behavior, a public interface, a command signature, an architecture constraint, or a domain fact documented in `AGENTS.md`, `docs/idea.md`, `docs/architecture/`, or `.ai/docs/`.
