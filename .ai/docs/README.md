...
- Non-trivial UI design variants route through `.ai/pipelines/implement-design-variant.md`.
...
- Non-trivial validation evidence comes from `.ai/agents/test-runner.md`; non-trivial visual review comes from `.ai/agents/design-reviewer.md`.
