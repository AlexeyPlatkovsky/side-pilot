...
Skill: `.claude/skills/triage-bug/SKILL.md`
...
| `needs-more-info` | Return the blocking question(s) to the user. Then load `.claude/skills/task-complete/SKILL.md`. Required output: `Skill: task-complete - output below` |
| `known-issue` | Record the existing reference. Then load `.claude/skills/task-complete/SKILL.md`. Required output: `Skill: task-complete - output below` |
| `wont-fix` | Record the rationale. Then load `.claude/skills/task-complete/SKILL.md`. Required output: `Skill: task-complete - output below` |
